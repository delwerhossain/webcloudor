export default function Home() {
  return (
    <main style={{ backgroundImage: "url(/order-bg.webp)" }}
     className=" w-full  bg-no-repeat bg-cover flex min-h-screen flex-col items-center justify-between p-24">
      <header className="lg:w-1/3 text-center ">
      <h1 className="font-manrope font-bold text-4xl leading-10 text-black text-center">Order Place</h1>
      <p className="mt-1 hidden lg:block font-normal text-lg leading-8 text-gray-900 mb-11 text-center">
            Thanks for making a purchase you can check our order summary frm
            below
          </p>
      </header>
      <section className="py-24 lg:py-36 bg-transparent overflow-hidden">
